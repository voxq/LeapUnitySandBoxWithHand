...
--------------------------------------------------------------------------------
Linux support for Unity was introduced in Unity 4.0. Our Linux package includes
a pre-built 32-bit Linux executable for UnitySandbox. To build this, you must
run the Unity 4 editor under Windows or Mac OS X.
